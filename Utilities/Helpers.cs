...
namespace Utilities
{
    public class Helpers
    {
        ...
        public static string GenerateCharacters(int length, CHARACTER_TYPE characterType)
        {
            String chars = String.Empty;
            switch (characterType)
            {
                case CHARACTER_TYPE.ALPHANUMERIC:
                    chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";
                    break;
                case CHARACTER_TYPE.NUMERIC:
                    chars = "1234567890";
                    break;
        ...
        public static void EncryptFile(string filePath, string inputPassword, string outputFullPath)
        {
            ...
            string fileEncrypted = outputFullPath;

            File.WriteAllBytes(fileEncrypted, bytesEncrypted);
        }

        public static void DecryptFile(string encryptedFile, String inputPassword, string outputFullPath)
        {
            string fileEncrypted = encryptedFile;
            string password = inputPassword;
